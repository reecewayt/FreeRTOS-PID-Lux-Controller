...
set_property PACKAGE_PIN K2 [get_ports pid_LED]					
	set_property IOSTANDARD LVCMOS33 [get_ports pid_LED]
...
# <---- I2C Pins ----> ##	
# JB Pin 3 -> JB3
set_property PACKAGE_PIN V11 [get_ports sclk_io]
# JB Pin 4 -> JB4					
set_property PACKAGE_PIN V15 [get_ports sda_io]					
	
### Set these to be pullups 
